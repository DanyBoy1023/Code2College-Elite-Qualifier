...
def load_words():
    ...
    print('Loaded ' + str(len(all_words)) + ' words in ' +
...
def jaccard_index(text, all_words):
    ...
    return display_similar(jaccard_indexes, all_words)
...
def display_similar(jaccard_indexes, all_words):
    ...
    return (all_words[jaccard_indexes.index(sorted_JIndex[last_index])])
...
def suggest(text, all_words):
    if text in all_words:
        ...
        return jaccard_index(text, all_words)
